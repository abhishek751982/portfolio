...
export const experiences = [
  {
    ...
    desc: "Developed and maintained RESTful APIs for an e-commerce application from scratch using NodeJS, ReactJS, and MongoDB, and S3 Bucket for image uploads. Enhanced data retrieval and storage efficiency by 30% through optimized database queries and collaborated with frontend developers to integrate and test API endpoints.",
    skills: [
      "ReactJS",
      "NodeJs",
      "MongoDB",
